...
fn bench(c: &mut Criterion) {
    bench_noise1d(c, "value_1d", SHAPE_1D, SCALE, &generator1d());
    bench_noise2d(c, "value_2d", SHAPE_2D, SCALE, &generator2d());
    bench_noise3d(c, "value_3d", SHAPE_3D, SCALE, &generator3d());
    bench_noise4d(c, "value_4d", SHAPE_4D, SCALE, &generator4d());
}
