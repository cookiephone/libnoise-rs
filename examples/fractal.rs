...
fn example_fractal_simplex_noise1d() {
    let shape = &[100];
    let generator = combiners::fractal::apply(sources::simplex::noise1d, 3, 0.013, 1.0, 2.0, 0.5);
...
fn example_fractal_simplex_noise2d() {
    let shape = &[1000, 1000];
    let generator = combiners::fractal::apply(sources::simplex::noise2d, 3, 0.013, 1.0, 2.0, 0.5);
    let noisebuf = NoiseBuffer::new(shape, generator, 42);
...
fn example_fractal_simplex_noise3d() {
    ...
    let generator = combiners::fractal::apply(sources::simplex::noise3d, 3, 0.013, 1.0, 2.0, 0.5);
    let noisebuf = NoiseBuffer::new(shape, generator, 42);
...
fn example_fractal_simplex_noise4d() {
    ...
    let generator = combiners::fractal::apply(sources::simplex::noise4d, 3, 0.033, 1.0, 2.0, 0.5);
    let noisebuf = NoiseBuffer::new(shape, generator, 42);
