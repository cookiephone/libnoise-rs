...
fn example_value_noise1d() {
    let shape = &[100];
    let generator = transforms::scale::apply(generators::value::noise1d, [0.013; 1]);
...
fn example_value_noise2d() {
    let shape = &[1000, 1000];
    let generator = transforms::scale::apply(generators::value::noise2d, [0.013; 2]);
    let noisebuf = NoiseBuffer::new(shape, generator, 42);
...
fn example_value_noise3d() {
    ...
    let generator = transforms::scale::apply(generators::value::noise3d, [0.013; 3]);
    let noisebuf = NoiseBuffer::new(shape, generator, 42);
...
fn example_value_noise4d() {
    ...
    let generator = transforms::scale::apply(generators::value::noise4d, [0.013; 4]);
    let noisebuf = NoiseBuffer::new(shape, generator, 42);
